...
if __name__ == "__main__":
    ...
    #answer_lines, answer_pts = embed_file( "/mnt/pccfs/backed_up/alexa_data/movie_stuff/movie_responses.txt")
    #np.save("/mnt/pccfs/backed_up/alexa_data/movie_stuff/movie_responses_pts.npy", answer_pts, allow_pickle=False )
    #np.save("/mnt/pccfs/backed_up/alexa_data/movie_stuff/movie_responses_lines.npy", answer_lines, allow_pickle=False )

    answer_pts = np.load("/mnt/pccfs/backed_up/alexa_data/movie_stuff/movie_responses_pts.npy")
    answer_lines = np.load("/mnt/pccfs/backed_up/alexa_data/movie_stuff/movie_responses_lines.npy")

    simple_chat( lines, pts, answer_lines, answer_pts, inputs, variation=variation )